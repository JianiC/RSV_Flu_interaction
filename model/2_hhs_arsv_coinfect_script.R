...
if(res_hhs1_arsv_coinfect$total2 == "fluA") message("Code itegration complete!")

save(res_hhs1_arsv_coinfect, file = "../test_result_coinfect/res_hhs1_arsv_coinfect.rds")
